...
Program read_test
use global
integer :: n,n1,n2,n3,n4,n5,ndomain,ii,ibegin=1200,iend=1200
...
OPEN(10,ACCESS='SEQUENTIAL',FILE='gp1.gnu')
...
!   ret=SYSTEM('mencoder mf://*.png -mf fps=1:type=png -ovc lavc -lavcopts vcodec=mpeg4:mbd=2:trell -oac copy -o hrir.avi')
!   ret=SYSTEM('rm *.png')
!***************************************************
!***************************************************
